...
* **editorCount**: number = 0; - считает количество открытых редакторов компонентов.
* **quantityExperiences** - дает общее количество experiences.
* **editing** - флаг редактирования.
* **candidateForm** - форма редактирования кандидата.
* **newExperienceForm** - форма добавление нового experience.
* **newReviewForm** - форма добавление нового review.
* **user** - имя пользователя, для добавления нового review. 
